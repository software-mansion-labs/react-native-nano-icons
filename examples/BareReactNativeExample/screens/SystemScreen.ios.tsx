...
// Continuous whole-symbol effects that need no special annotation, so our
// forged custom symbols animate them out of the box. (variableColor/drawOn/
// drawOff are excluded — they need variable/draw layer annotation our forge
// doesn't emit, so they'd just degrade to a pulse/fade.)
// bounce/pulse: iOS 17+; breathe/wiggle/rotate: iOS 18+.
  ...
  return (
    <SafeAreaView edges={['top']} style={styles.safe}>
      <ScrollView contentContainerStyle={styles.container}>
        ...
        <Text style={styles.line}>
          Continuous {'<SFSymbol>'} effects running on our custom folder symbol.
        </Text>
